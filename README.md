...
안녕하세요, Unity 기반의 게임 시스템을 직접 설계하고 구현해 온 개발자 최민준입니다.<br>
지난 4년간 TPS, FPS, 퍼즐 등 다양한 장르의 프로젝트를 주도하며, 캐릭터 제어부터 전투 시스템, 상태 이상 처리, UI 연동까지 전체 게임을 실전 수준으로 구현해 보았습니다.<br>
또한 디자이너 및 팀원과의 협업을 통해 기획 의도에 맞춘 기능 구현과 최적화를 수행했으며, 앞으로도 창의적인 시스템 설계와 팀워크를 기반으로 완성도 높은 게임 개발에 기여하고자 합니다.<br>
<br>
...
프로젝트 스타일: Unity 입문부터 함께한 대표 프로젝트, 창업 및 상업화를 목표로 외부 자원과 자금을 적극 활용한 실전형 개발 프로젝트

※ 해당 프로젝트는 상업화를 목표로 한 비공개 실전형 개발 프로젝트이며, GitHub에는 코드는 공개되어 있지 않습니다.
